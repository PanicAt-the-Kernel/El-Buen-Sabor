  ...
  function removeInsumo(id: number) {
    ...
    setTablaDetalle((filasActuales) =>
      filasActuales.map((item) =>
        item.articuloInsumo.id === id
          ? { ...item, eliminado: true, fechaBaja: fecha }
          : item
      )
    );
  }
        ...
        >
          <Stack spacing={2}>
            <TextField
              ...
              onChange={(e) =>
                setArticuloM({ ...articuloM, denominacion: e.target.value })
              }
              inputProps={{
                maxLength: 30,
              }}
            ...
            <TextField
              ...
              onChange={(e) =>
                setArticuloM({ ...articuloM, descripcion: e.target.value })
              }
              multiline
              rows={3}
            />
            ...
            <TextField
              ...
              onChange={(e) =>
                setArticuloM({ ...articuloM, preparacion: e.target.value })
              }
              multiline
              rows={3}
            />
