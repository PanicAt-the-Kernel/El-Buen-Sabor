...
} from "../../../../servicios/SucursalService";
...
export default function MostrarSucursalesModal({
  open,
  onClose,
  iEmpresa,
}: MostrarSucursalesModalProps) {
            ...
            .map((item: Sucursal) => (
              <ItemGrilla
                ...
                descripcion={
                  ...
                  " - " +
                  item.domicilio.localidad.nombre
                }
                info={
                  "Horario: Lunes a Domingos de 20:00 a 12:00, Sábados y Domingos de 11:00 a 15:00"
                }
              ...
              >
                <Button
                  ...
                  color="info"
                  startIcon={<Info />}
                  onClick={()=>{localSession.setSucursal("sucursal",item)}}
                >
                  Ingresar
                </Button>
                <Button
